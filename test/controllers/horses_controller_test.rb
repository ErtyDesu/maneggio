...
class HorsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post horses_url, params: { horse: { descrizione: @horse.descrizione, eta: @horse.eta, nome: @horse.nome } }
    end
  ...
  test "should update horse" do
    patch horse_url(@horse), params: { horse: { descrizione: @horse.descrizione, eta: @horse.eta, nome: @horse.nome } }
